...
const LootboxCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-3 bg-yellow-500 w-4/5 h-8 rounded-full flex items-center justify-center text-md font-bold text-white shadow-inner shadow-red-500">
        {numbers}
      </div>
      {hovered && (
