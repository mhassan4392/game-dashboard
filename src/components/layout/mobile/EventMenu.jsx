import EventMatch from "../../pages/events/EvantMatch";
        ...
        <MobileModel
          ...
          header={() => (
            <>
              ...
              <div className="bg-secondary bg-opacity-25 w-full flex justify-between items-start px-4">
                ...
                <div className="flex items-center justify-between space-x-5 flex-grow px-5">
          ...
          <TabsItems className="overflow-auto scrollbar flex-grow">
            <TabItem defaultTab tab="match" className="bg-dark">
              ...
              {[...Array(20)].map((ar, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between py-2 px-4 border-b border-opacity-20 border-secondary space-x-4"
                >
